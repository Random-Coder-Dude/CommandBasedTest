...
public class TunerConstants {
  ...
  public static final CANBus kCANBus = new CANBus("Bus 1", "./logs/example.hoot");
  ...
  public static final Distance kWheelRadius = Inches.of(1.9599038879037511);
  ...
  private static final Angle kBackRightEncoderOffset = Rotations.of(-0.203857421875);
  ...
  public static final double kMaxAngularRate =
      RotationsPerSecond.of(1.0).in(RadiansPerSecond); // 2 rotation per second max angular velocity
  ...
  public static final PathConstraints kPathConstraints =
      new PathConstraints(4.753, 10, 3 * Math.PI, 4 * Math.PI); // (0.2, 1, 2, 5);
  public static final PathConstraints kAutoAlignConstraints =
      new PathConstraints(4, 10, 3 * Math.PI, 4 * Math.PI); // (0.2, 1, 2, 5);
